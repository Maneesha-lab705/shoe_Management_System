...
//    }
    ...
    public InventoryDTO getAllSizeQty(String shoeCode, Integer size) {
        return conversionData.toInventoryDto(inventoryDAO.findByShoeCodeAndSize(shoeCode,size));
    }
    ...
    public List<InventoryDTO> getAll() {
        return conversionData.getALlInventoryDetails(inventoryDAO.findAll());
    }
